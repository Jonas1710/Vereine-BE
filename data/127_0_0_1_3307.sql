...
--
-- Host: 127.0.0.1:3307
-- Erstellungszeit: 23. Okt 2017 um 09:29
...
('root', '2017-10-23 07:08:58', '{"lang":"de","collation_connection":"utf8mb4_unicode_ci"}');
...
-- Datenbank: `verein`
--
CREATE DATABASE IF NOT EXISTS `verein` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `verein`;
...
INSERT INTO `verein` (`id`, `name`, `kategorie`, `mitgliederanzahl`, `bild`, `gründungsjahr`) VALUES
(1, 'Yb', 'Fussball', 10000, 'bild.jpg', 1879),
(2, 'Grizzlies', 'American Football', 12000, 'bild.png', 1931);
